...
const generateProcessExecRules = (processPolicy = {}, logTag, cwd) => {
  if (!Array.isArray(processPolicy.allowedExecutables)) {
...
export const generateProfile = (config, options = {}) => {
  ...
  const profile = [
    ...
    '',
    '; Process',
    ...generateProcessExecRules(processPolicy, logTag, cwd),
    '(allow process-fork)',
